...
import MateriPembagian from './MATERI/pembagian';
import MateriPerkalian from './MATERI/perkalian';
import MateriPerkalianScreen from './MATERI/materiPerkalian';
import materiPembagianScreen from './MATERI/materiPembagian';
...
const MenuNavigation = () => {
    return (
        ...
        >
            ...
            />
            <Stack.Screen
                name="MateriPembagian"
                component={MateriPembagian}
            />
            <Stack.Screen
                name="MateriPerkalian"
                component={MateriPerkalian}
            />
            <Stack.Screen
                name="MateriPerkalianScreen"
                component={MateriPerkalianScreen}
            />
            <Stack.Screen
                name="MateriPembagianScreen"
                component={materiPembagianScreen}
            />
            <Stack.Screen
                name="Tabel"
                component={Tabel}
